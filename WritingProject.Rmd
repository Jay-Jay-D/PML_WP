...
getDoParWorkers()
pml.training = "~/Escritorio/Practical Machine Learning/Project 1/pml-training.csv"
pml.testing = "~/Escritorio/Practical Machine Learning/Project 1/pml-testing.csv"
```
